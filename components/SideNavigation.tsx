...
const SECTIONS = [
  ...
  { id: "portfolio-analytics", icon: "📐", label: "포트 정량 분석",  group: "daily" },
  { id: "rebalancing",      icon: "⚖️", label: "리밸런싱",         group: "daily" },
  { id: "signal-fusion",    icon: "🐋", label: "시그널 융합",      group: "daily" },
  { id: "tech-divergence",  icon: "🔀", label: "승자·패자 분화",   group: "daily" },
  { id: "earnings-reality", icon: "🔍", label: "실적 사후 검증",    group: "daily" },
  { id: "thirteen-f",       icon: "🦅", label: "13F 전설 추적",     group: "daily" },
  { id: "options-signals",  icon: "📈", label: "옵션 시그널",      group: "daily" },
